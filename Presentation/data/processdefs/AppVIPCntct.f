...
#                        saisie est considéré VIP selon certains critères de bases.
# J04609 06jAN2016 JFO   Augmenter le critère de sélection VIP à 15000 pour la prime
#                        annuelle de base. Ajouter les produits Maladie Grave (MG) pour 
#                        la selection VIP dont le capital assuré doit être à 500000 et + 
#                        Pour les UL ne plus prendre le Sundry Amount comme calcul de sélection mais
#                        plutôt la prime annuelle de base.
# J06040 27May2019 JFO   Pour les polices ULs reprendre le prime annuel de base comme calcul de 
#                        selection VIP plutôt que le Sundry Amount. 
# *****************************************************************************
PROCESS AppVIPCntct
{
	VARIABLES
...
#J04609 La logique suivante n'est plus nécessaire	
#J06040 Réactiver le code pour le calcul avec le Sundry Amount.
